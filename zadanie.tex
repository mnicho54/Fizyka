...
\begin{table}[H]
    ...
    \section{Zadanie}
    \begin{flushleft}
        Dwóch kolegów trenują z piłkami jeden z piłką siatkową o wadze $m_1$, drugi z piłką tenisową o wadze $4m_1$. Jeden z nich wpada na pomysł aby te piłki zderzyć ze sobą więc rzucają swoje piłki tak że
        pierwsza leci pod kątem $\alpha _1$=0$^\circ$ z prędkością $v_1$=2$\frac{m}{s}$a druga pod kątem $\beta _1$=90$^\circ$ z prędkością $v_2$=1$\frac{m}{s}$,
        następnie zderzają się i lecą dalej gdzie pierwsza leci pod kątem $\beta _2$=300$^\circ$.
